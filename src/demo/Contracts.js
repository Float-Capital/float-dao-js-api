...
function make(address, providerOrWallet) {
  return Ethers.Contract.make(address, abi, providerOrWallet);
}
...
function make$1(address, providerOrWallet) {
  return Ethers.Contract.make(address, abi$1, providerOrWallet);
}
...
function make$2(address, providerOrWallet) {
  return Ethers.Contract.make(address, abi$2, providerOrWallet);
}
...
function make$3(address, providerOrWallet) {
  return Ethers.Contract.make(address, abi$3, providerOrWallet);
}
...
var abi$4 = Ethers.makeAbi(["function mintNFT(uint256 levelId, address receiver) external"]);

function make$4(address, providerOrWallet) {
  return Ethers.Contract.make(address, abi$4, providerOrWallet);
}
