...
function convertTxOptions(input) {
  return {
          maxFeePerGas: Ethers.BigNumber.from(input.maxFeePerGas).mul(oneGweiInWei).toString(),
          maxPriorityFeePerGas: Ethers.BigNumber.from(input.maxPriorityFeePerGas).mul(oneGweiInWei).toString(),
          gasLimit: Ethers.BigNumber.from(input.gasLimit).mul(oneGweiInWei).toString()
        };
}
...
exports.convertTxOptions = convertTxOptions;
